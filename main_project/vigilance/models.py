...
class Vigilance(models.Model):
    ...
    vigilance_ref_no=models.CharField(max_length=100, null=True, blank=True,verbose_name='Reference No. (VIGILANCE)')
    vigilance_dt= models.DateField(null=True,blank=True,verbose_name='Date')
    ...
    vigilance_inward_no=models.CharField(max_length=100, null=True, blank=True,verbose_name='Inward DP No.')
    vigilance_inward_dt= models.DateField(null=True,blank=True,verbose_name='Date')

    vigilance_hod = models.ManyToManyField(HOD, blank=True, related_name='HOD',verbose_name='Sent to HoD')
    vigilance_hod_reply = models.ManyToManyField(HOD, blank=True, related_name='HOD_reply', verbose_name='Received from HoD')
    ...
    vigilance_outward_ref= models.CharField(max_length=60, null=True, blank=True,verbose_name='Outward Reference No.')
    vigilance_outward_dt= models.DateField(null=True,blank=True,verbose_name='Date')
